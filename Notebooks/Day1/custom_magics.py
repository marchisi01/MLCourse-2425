...
def sc(num_workers):
    ...
    #finto HDFS 
    sconf.set("spark.kubernetes.executor.volumes.hostPath.data-corso.options.path", "/glusterstorage/volume-data-corso")
    sconf.set("spark.kubernetes.executor.volumes.hostPath.data-corso.mount.path", "/data-corso")
    sconf.set("spark.kubernetes.executor.volumes.hostPath.data-corso.mount.readOnly", "true")
    sconf.set("spark.kubernetes.executor.volumes.hostPath.home.options.path", "/glusterstorage/volume-"+username+"-mlwn")
    sconf.set("spark.kubernetes.executor.volumes.hostPath.home.mount.path", "/home/jovyan")
    sconf.set("spark.hadoop.fs.permissions.umask-mode","000")
